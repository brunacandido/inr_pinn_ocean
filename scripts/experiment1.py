#!/usr/bin/env python3
"""Experiment 1 — INR: dense training + uniformly sampled validation.

Validation profiles are drawn at random from the full spatial domain.
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Experiment 1: INR — dense training, uniform validation split.",
...
def main() -> None:
    run_experiment(
        ...
        val_mode       = "uniform",
        val_mode_label = "Uniform Validation",
        args           = parse_args(),
    )
